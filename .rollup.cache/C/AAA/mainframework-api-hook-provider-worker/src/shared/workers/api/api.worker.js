...
const isBinaryResponse = (r) =>
  !!r && typeof r === "object" && BINARY_MARKER in r && r[BINARY_MARKER] === true && r.data instanceof ArrayBuffer;
...
const appendToFormData = (formData, key, value, fileFieldName = DEFAULT_FILES_FIELD, visited) => {
  ...
  if (value !== null && value !== undefined && typeof value === "object") {
    ...
    for (const k in value) {
      if (Object.prototype.hasOwnProperty.call(value, k)) {
        hasFile = appendToFormData(formData, key ? `${key}.${k}` : k, value[k], fileFieldName, set) || hasFile;
      }
    }
    return hasFile;
  }
...
const createFormDataIfBlobOrFile = (
  payload,
  fileFieldName = DEFAULT_FILES_FIELD,
  formDataKey = DEFAULT_FILES_FIELD,
) => {
